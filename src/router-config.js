...
// import activeAmap from './page/activeAmap/index.vue'
import AMapPage from './page/activeAmap/AMapPage.vue'
import AmapDoc from './page/activeAmap/AmapDoc.vue'
import AmapPoint from './page/activeAmap/AmapPoint.vue'
...
export default [
        ...
        children: [
          {path:'',component: page1},
          {
            ...
            children: [
              ...
              // {path: 'gps_test', component: gps_test},
  ...
  }, { path:'/activePoint',component:AmapPoint },
  { path:'/activeAmap',component:AMapPage }
